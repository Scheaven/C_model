 ...
 
{
	...
	// PyRun_SimpleString("");
	PyRun_SimpleString("sys.path.append('/home/basic/workspace/Scheaven/C_test/004_py3_CPP/')");
	...
	pModule = PyImport_ImportModule("lib/bb");
 ...
 // 	unsigned char Pimg[1024*768*3];
 // 	int pwidth = 0;
 // 	int pheight = 0;
	// read_JPEG_file ("1.jpg", Pimg, &pwidth, &pheight);

	// unsigned char* img = Pimg;
	...
	// result2 = PyEval_CallObject(imgFunc, img);
